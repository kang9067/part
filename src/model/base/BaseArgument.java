...
public class BaseArgument {
    ...
    public BaseArgument fail() {
        this.code = FAILED;
        this.message = "失败";
        return this;
    }

    public BaseArgument fail(String msg) {
        this.code = FAILED;
        this.message = msg;
        return this;
    }

    public BaseArgument fail(int code, String msg) {
    ...
    public BaseArgument fail(int code, String msg, Map<String, Object> result) {
        if (code != 0 && code != SUCCESS) {
            code = FAILED;
        }
        this.code = code;
    ...
    public BaseArgument fail(Map<String, Object> result) {
        this.code = FAILED;
        this.message = "失败";
        this.rtn = result;
        return this;
    ...
    public BaseArgument success() {
        this.code = SUCCESS;
        this.message = "成功";
        return this;
    }
    
    public BaseArgument success(String message) {
        this.code = SUCCESS;
        this.message = message;
        return this;
    }

    public BaseArgument success(int code, String msg) {
    ...
    public BaseArgument success(int code, String msg, Map<String, Object> result) {
        if (code != 0 && code != FAILED) {
            code = SUCCESS;
        }
        this.code = code;
    ...
    public BaseArgument success(Map<String, Object> result) {
        this.code = SUCCESS;
        this.message = "成功";
        this.rtn = result;
        return this;
    ...
    public BaseArgument setCode(int code) {
        this.code = code;
        return this;
    }
    ...
    public BaseArgument setMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Integer getRowId(String idfeild) {
    ...
    public BaseArgument setRowId(Integer rowId) {
        this.rowId = rowId;
        return this;
    }
    ...
    public BaseArgument setNum(int num) {
        this.num = num;
        return this;
    }
    ...
    public BaseArgument setObj(Object obj) {
        this.obj = obj;
        return this;
    }
    ...
    public BaseArgument setReq(Map<String, Object> req) {
        this.req = req;
        return this;
    }
    ...
    public BaseArgument setRtn(Map<String, Object> result) {
        this.rtn = result;
        return this;
    }
    ...
    public BaseArgument setToRtn(String key, Object value) {
        this.rtn.put(key, value);
        return this;
    }

    public BaseArgument setToReq(String key, Object value) {
        this.req.put(key, value);
        return this;
    }
    
    public BaseArgument setDataToRtn(Object value) {
        this.rtn.put("data", value);
        return this;
    }

    public BaseArgument setDataToReq(Object value) {
