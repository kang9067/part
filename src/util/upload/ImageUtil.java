...
/**
 * 图片处理工具类
 * 内部使用了easyimage ：http://www.aviyehuda.com/downloads/easyimage/easyimage_javadoc/index
 * @author ziry
...
public class ImageUtil {
	 ...
	 * @throws IOException
	 */
	public static void crop(String srcpath, String subpath
							, int startX,int startY, int endX, int endY) throws IOException {
		util.upload.Image image = new util.upload.Image(srcpath);
	...
	public static void main(String[] args) throws Exception {
		// ImageUtil.qualityCompress("D:/temp/304.jpg", 0.7f);
