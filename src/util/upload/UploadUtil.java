...
public class UploadUtil {
	 ...
	 * 基础路径，带盘符的基础路径 D:/..../
	 */
	private static String BASEPATH = "D:/EnnUploadData";

	/**
	 * 根目录
	 */
	private static String ROOTPATE = "/UploadData";
	...
	public static boolean deleteFile(String webURL) throws IllegalArgumentException {
		...
		if (file.isFile() && file.exists()) {
			logger.info("删除图片 ：" + BASEPATH + webURL);
			return file.delete();
		}
	...
	public static boolean deleteWebFile(HttpServletRequest request, String webURL) throws IllegalArgumentException {
		...
		// 判断是否带域名
		if (webURL.lastIndexOf(".net/") != -1) {
			// 去除域名
			webURL = webURL.substring(webURL.indexOf(".net/") + 5);
		}
