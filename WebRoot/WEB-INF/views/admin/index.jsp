...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 前台页面管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="system/list.html" data-title="资讯管理" href="javascript:void(0)">主页轮播管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="active/list.html" data-title="活动列表" href="javascript:void(0)">活动列表</a></li>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="users/member-list.html" data-title="会员列表" href="javascript:;">会员列表</a></li>
...
<script type="text/javascript" src="<%=basePath %>public/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script> 
