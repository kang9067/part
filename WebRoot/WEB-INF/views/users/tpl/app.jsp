      ...
      <div class="row-row">
        <div class="cell">
          <div class="cell-inner padder">
            <!-- chat list -->
            <div class="m-b">
              <a href class="pull-left thumb-xs avatar"><img src="/public/users/img/a2.jpg" alt="..."></a>
              <div class="clear">
            ...
            <div class="m-b">
              <a href class="pull-right thumb-xs avatar"><img src="/public/users/img/a3.jpg" class="img-circle" alt="..."></a>
              <div class="clear">
