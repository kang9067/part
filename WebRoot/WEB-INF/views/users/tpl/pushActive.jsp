            ...
            <div class="panel-body">
              <p class="text-muted">Need support? please fill the fields below.</p>                        
                <div class="form-group pull-in clearfix">
                  <div class="col-sm-6">
                    <label>活动地址</label>
                    <input name='address'  type="text" class="form-control" placeholder="活动地址" ng-model="contact.name" required >
                  </div>
                  <div class="col-sm-6">
                    <label>价格</label>
                    <input name="price" type="text" class="form-control" placeholder="价格" ng-model="contact.email" required >
                  </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <label>活动标题</label>
                    <input name='title'  type="text" class="form-control" placeholder="活动标题" ng-model="contact.name" required >
                 </div>
            </div>
            <footer class="panel-footer text-right bg-light lter">
